...
// ** Comment by Ken **
// This service is used to transfer authentication state from Blazor server to client. So, it is not required for Blazor SSR only app.
public class MyServerASP : RevalidatingServerAuthenticationStateProvider
{
